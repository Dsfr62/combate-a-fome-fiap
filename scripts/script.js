...
export async function createMessage(data) {
    fetch('https://hook.us1.make.com/6s13x5j8qlon2mb3egjw091mfd1yvadx', {
        method: 'POST',
        body: data
    }).then(response => alert("Formulário enviado com sucesso!")).catch(err => {
...
export function openLinkedin() {
    window.open("https://www.linkedin.com/school/fiap/?originalSubdomain=br", "_blank")
}