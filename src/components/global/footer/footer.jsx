...
const Footer = () => {
    ...
    return (
        <div className="w-full h-auto flex flex-col md:grid md:grid-cols-3 bg-primary-default px-8 md:px-16 py-8 text-sm justify-between">
            ...
            <div className="w-full flex flex-col">
                <p className="text-white font-bold text-lg mb-2 p-0 md:px-4 text-start md:text-end">REDES SOCIAIS</p>
                ...
                <p className="font-bold text-white text-lg p-0 md:px-4 mt-8 text-start md:text-end">2023 Vida Nova</p>
            </div>
