            ...
            <div className="max-w-[1440px] mx-auto w-full h-auto flex flex-col md:grid md:grid-cols-3 px-8 py-8 text-sm justify-between">
                ...
                <div className="w-full flex flex-col">
                    ...
                    <div className="flex gap-2 p-0 md:px-4 self-start md:self-end">
                        <BsInstagram size={40} className="p-2 rounded-2xl bg-white text-primary-default cursor-pointer hover:opacity-90 ease-linear transition-all " onClick={openInstagram} />
                        <BsLinkedin size={40} className="p-2 rounded-2xl bg-white text-primary-default cursor-pointer hover:opacity-90 ease-linear transition-all " onClick={openLinkedin} />
                        <BsFacebook size={40} className="p-2 rounded-2xl bg-white text-primary-default cursor-pointer hover:opacity-90 ease-linear transition-all " onClick={openFacebook} />
                    </div>
