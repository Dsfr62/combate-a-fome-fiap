...
const DadosSixthSection = () => {
    return (
        <div className="w-full flex flex-col h-auto items-start md:items-center justify-center my-6 p px-4 md:px-12">
            <p className="text-2xl md:text-3xl text-secondary-default text-start md:text-center w-full font-bold mb-6">
...
export default DadosSixthSection